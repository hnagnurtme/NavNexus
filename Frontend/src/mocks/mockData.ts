...
const mockDetailsMap: Record<string, NodeDetailsResponse> = {
  ...
  'problem-resource': {
    ...
    evidence: [
      {
        id: 'ev-sagsins-1',
        sourceName: 'SAGSINs.pdf',
        text: 'Resource allocation in SAGINs is highly complex due to dynamic topology and heterogeneous resources.',
        hierarchyPath: 'Page 3, Section 2.1',
        sourceId: 'file-sagsins',
        chunkId: 'chunk-sagsins-1',
        page: 3,
        confidence: 0.92,
        createdAt: new Date('2024-01-15').toISOString(),
        language: 'en',
        sourceLanguage: 'en',
        concepts: ['Resource Allocation', 'SAGINs', 'Dynamic Topology'],
        keyClaims: ['Complex allocation problem', 'Heterogeneous resources'],
        questionsRaised: ['How to optimize resource allocation in dynamic networks?'],
      ...
      },
      {
        ...
        hierarchyPath: 'Page 7, Conclusion',
        sourceId: 'file-rl2',
        chunkId: 'chunk-rl2-1',
        page: 7,
        confidence: 0.85,
        ...
        language: 'en',
        sourceLanguage: 'en',
        concepts: ['AI', 'RL', 'SAGIN'],
        keyClaims: ['AI methods are promising', 'Lack of implementation'],
        questionsRaised: ['What specific algorithms can be applied to SAGIN?'],
    ...
    evidence: [
      {
        ...
        hierarchyPath: 'Page 5, Section IV',
        sourceId: 'file-gap',
        chunkId: 'chunk-gap-1',
        page: 5,
        confidence: 0.95,
        ...
        language: 'en',
        sourceLanguage: 'en',
        concepts: ['PPO', 'Attention Mechanism', 'Resource Allocation'],
        keyClaims: ['Attention-enabled PPO optimizes computation offloading'],
        questionsRaised: [],
    ...
    evidence: [
      {
        ...
        language: 'en',
        sourceLanguage: 'en',
        concepts: ['Alternating Optimization', 'Sub-problems'],
        keyClaims: ['Iteratively solve five sub-problems'],
        questionsRaised: [],
